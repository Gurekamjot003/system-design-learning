...
public:
    ...
    Logger(){
        notification_observable = NotificationService::get_instance()->get_observable();
        notification_observable->add_observer(this);
    }
...
int main(){
    ...
    NotificationEngine* notification_engine = new NotificationEngine();
